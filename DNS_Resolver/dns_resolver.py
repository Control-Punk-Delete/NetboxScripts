...
class DnsResolve(Script):
    ...
    def run(self, data, commit):
        ...
        self.log_debug(f"Dns record get tenant {tenant}")
        ...
        # IP Address is returned (next check is CDN)
            ...
            for ip_to_check in resolved_ips:
                ...
                if "cdn" in TAGS_IP_VALIDATION:
                    ...
                    ipaddr, created = IPAddress.objects.get_or_create(address=ip_to_check, defaults={'status': 'active', 'tenant_id': tenant})
