...
class DnsResolve(Script):
    ...
    def run(self, data, commit):
        ...
        CDN_IPs_LIST_STRINGS = ["2.16.0.0/13",
        "4.77.205.0/24",
        "8.28.5.0/24",
        "8.31.234.0/24",
        "8.38.97.0/24",
        ...
        for ip in CDN_IPs_LIST_STRINGS:
            try:
        ...
        def is_cdn(self, ip):
            if ip.version == 4:
                ...
                self.log_debug("ERROR: Function is_cdn get wrong ip_type parameter.")
            return False

        def ip_validator(self, ip: str):
            TAGS = []
